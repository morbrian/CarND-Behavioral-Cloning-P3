...
def initialize_folder(input_folder_name, min_filter=0.001, min_keep_prob=0.1):
    ...
    balanced_folder.balance_data(min_filter=min_filter, min_keep_prob=min_keep_prob)
